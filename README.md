...
6. «Тройка»: сектор 8, блоки 32–34 — 48-байтовая транспортная запись,
   ...
   E1/E3/E5: номер карты (биты 20–51), баланс; у E3/E5 — последняя
   поездка и срок действия карты, у E5 — ещё последнее пополнение
   и счётчики. Билетные записи (проездные) — сектора 7, 4 и 1,
   layout'ы 2/A/D/E2: остаток поездок и срок действия
